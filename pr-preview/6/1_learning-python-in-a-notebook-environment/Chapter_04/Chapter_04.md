...
```
    ...
    Symmetric Difference: {'gpa', 'major', 'admitted', 'minor', 'advisor'}
    Intersection: {'id', 'last', 'first'}
    Difference: {'admitted'}
    Union: {'gpa', 'major', 'admitted', 'minor', 'first', 'id', 'last', 'advisor'}
...
```
    ...
    Calling __hash__ on string: -3777267129638939084
