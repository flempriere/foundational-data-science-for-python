...
```
    ...
    Symmetric Difference: {'gpa', 'admitted', 'major', 'minor', 'advisor'}
    Intersection: {'first', 'last', 'id'}
    Difference: {'admitted'}
    Union: {'first', 'id', 'admitted', 'minor', 'gpa', 'major', 'last', 'advisor'}
...
```
    ...
    Calling __hash__ on string: -3472750701021918118
