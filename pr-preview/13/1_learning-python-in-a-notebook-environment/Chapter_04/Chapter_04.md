...
```
    ...
    Symmetric Difference: {'gpa', 'advisor', 'admitted', 'major', 'minor'}
    Intersection: {'id', 'last', 'first'}
    Difference: {'admitted'}
    Union: {'gpa', 'advisor', 'admitted', 'major', 'id', 'last', 'minor', 'first'}
...
```
    ...
    Calling __hash__ on string: -332015601557024778
