...
```
    ...
    Symmetric Difference: {'gpa', 'major', 'admitted', 'advisor', 'minor'}
    Intersection: {'id', 'last', 'first'}
    Difference: {'admitted'}
    Union: {'gpa', 'major', 'admitted', 'last', 'advisor', 'minor', 'first', 'id'}
...
```
    ...
    Calling __hash__ on string: 7338296935103657666
