...
```
    ...
    Symmetric Difference: {'advisor', 'minor', 'gpa', 'major', 'admitted'}
    Intersection: {'last', 'id', 'first'}
    Difference: {'admitted'}
    Union: {'advisor', 'minor', 'gpa', 'first', 'last', 'id', 'major', 'admitted'}
...
```
    ...
    Calling __hash__ on string: 2726846256373104534
