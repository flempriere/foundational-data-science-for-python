...
```
    ...
    <div>
        ...
        <span id="cd04b00f-3b07-43ef-96d9-ebcdf94c4e7d">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="a19a5470-3a01-4a42-954a-bb298923183d" data-root-id="p1085" style="display: contents;"></div>
