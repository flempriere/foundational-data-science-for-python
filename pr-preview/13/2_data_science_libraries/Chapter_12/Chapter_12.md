...
```
    ...
    SyntaxError: expected 'else' after 'if' expression (2758462587.py, line 10)
      Cell In[10], line 10
        caesar_filtered = [word if word not in string.punctuation for word in caesar]
                           ^
...
```
    ...
    SyntaxError: expected 'else' after 'if' expression (302625105.py, line 9)
      Cell In[12], line 9
        caesar_punctuation_filtered = [word if word not in string.punctuation for word in caesar]
                                       ^
    SyntaxError: expected 'else' after 'if' expression
...
```
    ...
    SyntaxError: expected 'else' after 'if' expression (2782868342.py, line 9)
      Cell In[13], line 9
        caesar_filtered = [word if word not in string.punctuation for word in caesar]
                           ^
    SyntaxError: expected 'else' after 'if' expression
...
```
    ...
    Cell In[18], line 71
         67     flatten(paragraph) for paragraph in editorial_paragraphs
         68 ]
         69 fiction_paragraphs_flattened = [flatten(paragraph) for paragraph in fiction_paragraphs]
         70 
    ---> 71 print("Flattened editorial paragraphs:\n", "\n".join(editorial_paragraphs_flattened))
...
3.  Use tabulate to view the top 10 words in *Alice in Wonderland*,
    ...
    - Finally we create our `FreqDist` and call `tabulate`
      ...
      ```
          ...
          SyntaxError: expected 'else' after 'if' expression (3058071302.py, line 9)
            Cell In[28], line 9
              alice_filtered = [word if word not in string.punctuation for word in alice]
                                ^
          SyntaxError: expected 'else' after 'if' expression
...
```
    ...
    SyntaxError: expected 'else' after 'if' expression (1411831106.py, line 22)
      Cell In[33], line 22
        alice_filtered = [word if word not in string.punctuation for word in alice]
                          ^
    SyntaxError: expected 'else' after 'if' expression
