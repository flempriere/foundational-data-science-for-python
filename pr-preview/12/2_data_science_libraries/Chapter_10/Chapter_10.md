...
```
    ...
    <div>
        ...
        <span id="a9ec87a5-35d2-432f-9f68-d0ab423563ed">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="acbc4b4d-175b-4c41-99e9-1c36d3f2c56f" data-root-id="p1085" style="display: contents;"></div>
