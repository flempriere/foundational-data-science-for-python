...
```
    ...
    <div>
        ...
        <span id="b882596e-5c84-450b-b3e5-ba4d715de08b">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="b1ba8efb-328a-4c7f-a6af-8a61e26b6994" data-root-id="p1085" style="display: contents;"></div>
