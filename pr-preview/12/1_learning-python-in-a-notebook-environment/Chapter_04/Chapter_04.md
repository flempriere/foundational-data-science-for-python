...
```
    ...
    Symmetric Difference: {'gpa', 'major', 'advisor', 'admitted', 'minor'}
    Intersection: {'last', 'id', 'first'}
    Difference: {'admitted'}
    Union: {'gpa', 'major', 'advisor', 'admitted', 'last', 'minor', 'first', 'id'}
...
```
    ...
    Calling __hash__ on string: -6184458089863395272
