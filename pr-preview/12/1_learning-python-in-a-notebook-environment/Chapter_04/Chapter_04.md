...
```
    ...
    Symmetric Difference: {'major', 'advisor', 'gpa', 'minor', 'admitted'}
    Intersection: {'last', 'first', 'id'}
    Difference: {'admitted'}
    Union: {'last', 'major', 'advisor', 'gpa', 'id', 'minor', 'admitted', 'first'}
...
```
    ...
    Calling __hash__ on string: 7832441723415982492
