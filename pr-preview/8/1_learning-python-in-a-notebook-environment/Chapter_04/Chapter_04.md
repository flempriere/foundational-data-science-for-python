...
```
    ...
    Symmetric Difference: {'advisor', 'minor', 'gpa', 'admitted', 'major'}
    Intersection: {'first', 'last', 'id'}
    Difference: {'admitted'}
    Union: {'advisor', 'minor', 'gpa', 'last', 'id', 'first', 'admitted', 'major'}
...
```
    ...
    Calling __hash__ on string: -8971560677151864804
