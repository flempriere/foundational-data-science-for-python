...
```
    ...
    Symmetric Difference: {'major', 'gpa', 'admitted', 'minor', 'advisor'}
    Intersection: {'first', 'id', 'last'}
    Difference: {'admitted'}
    Union: {'major', 'id', 'gpa', 'last', 'admitted', 'minor', 'first', 'advisor'}
...
```
    ...
    Calling __hash__ on string: -9037668360065050683
