...
```
    ...
    Symmetric Difference: {'advisor', 'admitted', 'major', 'minor', 'gpa'}
    Intersection: {'id', 'last', 'first'}
    Difference: {'admitted'}
    Union: {'advisor', 'admitted', 'major', 'minor', 'last', 'id', 'first', 'gpa'}
...
```
    ...
    Calling __hash__ on string: -8166490587707239926
