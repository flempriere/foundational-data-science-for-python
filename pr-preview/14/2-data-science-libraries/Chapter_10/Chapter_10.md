...
```
    ...
    <div>
        ...
        <span id="ea9447f9-892f-40c3-9b80-adfdeaa96539">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="efa90029-b745-480b-b746-9bafe282fa1f" data-root-id="p1085" style="display: contents;"></div>
