...
```
    ...
    <div>
        ...
        <span id="e6f774d8-c892-4199-aa42-bb8cba468918">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="f95d5459-174f-4247-aff2-bacfcef3df6f" data-root-id="p1085" style="display: contents;"></div>
