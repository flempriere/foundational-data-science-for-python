...
```
    ...
    <div>
        ...
        <span id="af7eed9e-65cf-437d-a956-375ef1e33fd7">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="f2c8cf71-27f5-409e-a041-8b699a19f8dc" data-root-id="p1085" style="display: contents;"></div>
