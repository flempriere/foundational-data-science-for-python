...
```
    ...
    Symmetric Difference: {'admitted', 'gpa', 'major', 'minor', 'advisor'}
    Intersection: {'id', 'last', 'first'}
    Difference: {'admitted'}
    Union: {'admitted', 'gpa', 'last', 'major', 'id', 'minor', 'advisor', 'first'}
...
```
    ...
    Calling __hash__ on string: 6129515115191797025
...
```
    ...
    Empty set via {}: {}
    Set constructed via `set` called on a string: {'c', 'b', 'a'}
    Set constructed via `set` called on a tuple: {'c', 'b', 'a'}
