...
```
    ...
    Symmetric Difference: {'advisor', 'major', 'admitted', 'minor', 'gpa'}
    Intersection: {'last', 'first', 'id'}
    Difference: {'admitted'}
    Union: {'advisor', 'id', 'last', 'first', 'major', 'admitted', 'minor', 'gpa'}
...
```
    ...
    Calling __hash__ on string: -7051993397147152119
