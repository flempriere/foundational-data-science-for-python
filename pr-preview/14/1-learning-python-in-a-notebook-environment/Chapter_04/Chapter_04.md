...
```
    ...
    Symmetric Difference: {'major', 'gpa', 'minor', 'admitted', 'advisor'}
    Intersection: {'last', 'first', 'id'}
    Difference: {'admitted'}
    Union: {'first', 'id', 'major', 'gpa', 'minor', 'admitted', 'advisor', 'last'}
...
```
    ...
    Calling __hash__ on string: 7636193722401895108
