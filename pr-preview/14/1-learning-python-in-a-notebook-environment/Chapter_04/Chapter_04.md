...
```
    ...
    Symmetric Difference: {'advisor', 'major', 'gpa', 'admitted', 'minor'}
    Intersection: {'first', 'id', 'last'}
    Difference: {'admitted'}
    Union: {'advisor', 'last', 'major', 'minor', 'first', 'admitted', 'id', 'gpa'}
...
```
    ...
    Calling __hash__ on string: -7133240959455687877
