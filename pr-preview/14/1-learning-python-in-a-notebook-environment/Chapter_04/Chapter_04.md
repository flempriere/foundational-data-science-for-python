...
```
    ...
    Symmetric Difference: {'admitted', 'minor', 'major', 'gpa', 'advisor'}
    Intersection: {'id', 'last', 'first'}
    Difference: {'admitted'}
    Union: {'admitted', 'minor', 'last', 'major', 'id', 'gpa', 'first', 'advisor'}
...
```
    ...
    Calling __hash__ on string: 966348854247653123
