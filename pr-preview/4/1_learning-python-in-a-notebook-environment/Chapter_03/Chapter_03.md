...
```
    ...
    <>:5: SyntaxWarning: "is" with 'str' literal. Did you mean "=="?
    /tmp/ipykernel_2982/2287492867.py:5: SyntaxWarning: "is" with 'str' literal. Did you mean "=="?
      print("Here "is" a string")
...
```
    ...
    TypeError                                 Traceback (most recent call last)
    Cell In[40], line 9
          5 print(" a is in my_list", a in my_list)
          6 
          7 # Question 2
          8 my_string = "bee"
    ----> 9 print(f"b appears {my_string.count()} times in my_string")
         10 
         11 # Question 3
         12 my_list.append(a)
