...
```
    ...
    <>:5: SyntaxWarning: "is" with 'str' literal. Did you mean "=="?
    /tmp/ipykernel_3031/2287492867.py:5: SyntaxWarning: "is" with 'str' literal. Did you mean "=="?
      print("Here "is" a string")
...
# Question 4
print("The strings  'superior' and \"superior\" are equal:", 'superior' == "superior")s

# Question 5
print("The numbers generated by range(3, 14) are:", list(range(3, 14)))
```

    SyntaxError: invalid syntax (3622089188.py, line 16)
      Cell In[40], line 16
        print("The strings  'superior' and \"superior\" are equal:", 'superior' == "superior")s
                                                                                              ^
