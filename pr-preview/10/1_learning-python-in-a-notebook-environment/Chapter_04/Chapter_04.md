...
```
    ...
    Symmetric Difference: {'major', 'admitted', 'advisor', 'minor', 'gpa'}
    Intersection: {'last', 'id', 'first'}
    Difference: {'admitted'}
    Union: {'admitted', 'major', 'first', 'advisor', 'id', 'minor', 'gpa', 'last'}
...
```
    ...
    Calling __hash__ on string: 4358613830896714275
