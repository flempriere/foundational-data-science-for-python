...
```
    ...
    Symmetric Difference: {'minor', 'gpa', 'advisor', 'admitted', 'major'}
    Intersection: {'id', 'first', 'last'}
    Difference: {'admitted'}
    Union: {'minor', 'id', 'gpa', 'advisor', 'admitted', 'major', 'last', 'first'}
...
```
    ...
    Calling __hash__ on string: -3865716447948191424
