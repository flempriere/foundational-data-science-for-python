...
```
    ...
    Symmetric Difference: {'admitted', 'advisor', 'minor', 'gpa', 'major'}
    Intersection: {'id', 'first', 'last'}
    Difference: {'admitted'}
    Union: {'id', 'admitted', 'advisor', 'minor', 'gpa', 'last', 'major', 'first'}
...
```
    ...
    Calling __hash__ on string: -2387747084606708189
