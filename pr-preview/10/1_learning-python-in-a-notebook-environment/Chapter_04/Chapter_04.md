...
```
    ...
    Symmetric Difference: {'major', 'advisor', 'minor', 'admitted', 'gpa'}
    Intersection: {'id', 'last', 'first'}
    Difference: {'admitted'}
    Union: {'gpa', 'major', 'advisor', 'id', 'last', 'minor', 'admitted', 'first'}
...
```
    ...
    Calling __hash__ on string: -8970884889565733396
