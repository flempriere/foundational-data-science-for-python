...
```
    ...
    Symmetric Difference: {'advisor', 'major', 'admitted', 'gpa', 'minor'}
    Intersection: {'first', 'last', 'id'}
    Difference: {'admitted'}
    Union: {'advisor', 'major', 'id', 'admitted', 'gpa', 'first', 'last', 'minor'}
...
```
    ...
    Calling __hash__ on string: 3064979198255419605
