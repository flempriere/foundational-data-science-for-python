...
```
    ...
    <div>
        ...
        <span id="f0f24b96-c3a6-47af-8b98-1dc53b204547">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="f3a750f2-8d9f-4254-b775-f25dc941d588" data-root-id="p1085" style="display: contents;"></div>
