...
```
    ...
    <div>
        ...
        <span id="df2637b7-daff-4b1f-aba1-09b55aa55d5a">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="b81ea4d3-2629-4214-8b72-aaf5329606fd" data-root-id="p1085" style="display: contents;"></div>
