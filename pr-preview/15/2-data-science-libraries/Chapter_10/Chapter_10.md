...
```
    ...
    <div>
        ...
        <span id="e3030208-eeca-4645-a929-9360f01af2ea">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="f11293dd-e4b5-4255-80c2-c6ea389ca17a" data-root-id="p1085" style="display: contents;"></div>
