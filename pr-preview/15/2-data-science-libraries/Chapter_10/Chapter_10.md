...
```
    ...
    <div>
        ...
        <span id="c2d3d402-27c0-4fe4-b820-5a84e7e62e9b">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="d6dbd542-932f-45d4-8e5c-a9cbfd4ebf47" data-root-id="p1085" style="display: contents;"></div>
