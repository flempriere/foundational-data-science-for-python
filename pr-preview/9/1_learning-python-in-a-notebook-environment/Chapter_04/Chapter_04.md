...
```
    ...
    Symmetric Difference: {'admitted', 'major', 'gpa', 'advisor', 'minor'}
    Intersection: {'first', 'id', 'last'}
    Difference: {'admitted'}
    Union: {'first', 'admitted', 'major', 'gpa', 'id', 'last', 'advisor', 'minor'}
...
```
    ...
    Calling __hash__ on string: -5960576194106724635
