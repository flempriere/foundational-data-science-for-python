...
```
    ...
    Symmetric Difference: {'admitted', 'minor', 'advisor', 'major', 'gpa'}
    Intersection: {'id', 'last', 'first'}
    Difference: {'admitted'}
    Union: {'id', 'admitted', 'minor', 'advisor', 'major', 'last', 'first', 'gpa'}
...
```
    ...
    Calling __hash__ on string: -6885191483712545946
