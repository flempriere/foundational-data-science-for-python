...
```
    ...
    Symmetric Difference: {'admitted', 'major', 'advisor', 'minor', 'gpa'}
    Intersection: {'id', 'first', 'last'}
    Difference: {'admitted'}
    Union: {'admitted', 'id', 'major', 'first', 'last', 'advisor', 'minor', 'gpa'}
...
```
    ...
    Calling __hash__ on string: -3215622453827991244
