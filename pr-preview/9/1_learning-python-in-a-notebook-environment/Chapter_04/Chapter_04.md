...
```
    ...
    Symmetric Difference: {'minor', 'admitted', 'gpa', 'advisor', 'major'}
    Intersection: {'last', 'id', 'first'}
    Difference: {'admitted'}
    Union: {'minor', 'id', 'admitted', 'gpa', 'advisor', 'first', 'major', 'last'}
...
```
    ...
    Calling __hash__ on string: -529184753510118660
