...
```
    ...
    Symmetric Difference: {'advisor', 'major', 'gpa', 'minor', 'admitted'}
    Intersection: {'id', 'last', 'first'}
    Difference: {'admitted'}
    Union: {'advisor', 'major', 'last', 'gpa', 'minor', 'id', 'admitted', 'first'}
...
```
    ...
    Calling __hash__ on string: -4629524583608600057
