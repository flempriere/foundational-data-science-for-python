...
```
    ...
    Symmetric Difference: {'minor', 'gpa', 'advisor', 'major', 'admitted'}
    Intersection: {'last', 'id', 'first'}
    Difference: {'admitted'}
    Union: {'minor', 'gpa', 'first', 'advisor', 'last', 'major', 'id', 'admitted'}
...
```
    ...
    Calling __hash__ on string: -8289594031894965487
