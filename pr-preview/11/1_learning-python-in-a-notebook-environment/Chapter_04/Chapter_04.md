...
```
    ...
    Symmetric Difference: {'gpa', 'admitted', 'minor', 'major', 'advisor'}
    Intersection: {'last', 'id', 'first'}
    Difference: {'admitted'}
    Union: {'gpa', 'first', 'admitted', 'minor', 'last', 'major', 'id', 'advisor'}
...
```
    ...
    Calling __hash__ on string: -3778885555371941580
