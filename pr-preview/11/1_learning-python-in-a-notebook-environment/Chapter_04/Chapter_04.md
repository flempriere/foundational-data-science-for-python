...
```
    ...
    Symmetric Difference: {'minor', 'advisor', 'gpa', 'admitted', 'major'}
    Intersection: {'first', 'last', 'id'}
    Difference: {'admitted'}
    Union: {'last', 'admitted', 'id', 'minor', 'advisor', 'gpa', 'first', 'major'}
...
```
    ...
    Calling __hash__ on string: -1898695726177023103
