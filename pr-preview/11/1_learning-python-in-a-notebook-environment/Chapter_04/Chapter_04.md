...
```
    ...
    Symmetric Difference: {'major', 'advisor', 'gpa', 'admitted', 'minor'}
    Intersection: {'last', 'first', 'id'}
    Difference: {'admitted'}
    Union: {'major', 'advisor', 'gpa', 'admitted', 'minor', 'id', 'last', 'first'}
...
```
    ...
    Calling __hash__ on string: -6731369800104952939
