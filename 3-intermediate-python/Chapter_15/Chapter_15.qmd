...
- If you want a sorted *copy* then you can use the `sorted` built-in function
...
- Once you've finished with a file you must call the `close` method to close the stream
    - Frees the resource
