...
- For this analysis we only care about the unique words in a paragraph
    ...
    - We also want to normalise the words to be all lower case for easier analysis
