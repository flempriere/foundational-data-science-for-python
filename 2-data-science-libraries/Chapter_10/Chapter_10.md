...
```
    ...
    <div>
        ...
        <span id="ff97a166-dd5f-4a91-a5ea-f3988f2b4ad0">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="b71321f3-90fc-479a-82d2-d1155f5ae550" data-root-id="p1085" style="display: contents;"></div>
