...
```
    ...
    <div>
        ...
        <span id="f8df9838-368d-42b9-9a05-9b5cadc3e783">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="db83a816-9f7c-45c9-878a-50e2e854cbc3" data-root-id="p1085" style="display: contents;"></div>
