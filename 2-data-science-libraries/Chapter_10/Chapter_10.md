...
```
    ...
    <div>
        ...
        <span id="d2d4a456-95d7-48c1-bd8b-f024b6a10bd7">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="f8676276-83b9-44e0-b5ef-31228a66df60" data-root-id="p1085" style="display: contents;"></div>
