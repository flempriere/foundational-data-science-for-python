...
```
    ...
    <div>
        ...
        <span id="e8670a3a-5a8e-46d1-818d-37a5061913f6">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="e3a9fa9e-1798-4ca7-b744-89e5af31470c" data-root-id="p1085" style="display: contents;"></div>
