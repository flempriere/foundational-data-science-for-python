...
```
    ...
    <div>
        ...
        <span id="f2ce4c72-666f-48a7-b9cb-bc45f2b6b7cc">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="c269ecd9-98a4-4c9d-b63a-4d885d040488" data-root-id="p1085" style="display: contents;"></div>
