...
```
    ...
    <div>
        ...
        <span id="e2375dc9-685d-4ef9-a9a6-28e50f343325">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="b5bd6739-b3c5-45e6-81ad-158a0565dbe9" data-root-id="p1085" style="display: contents;"></div>
