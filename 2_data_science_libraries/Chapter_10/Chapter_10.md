...
```
    ...
    <div>
        ...
        <span id="ff2d358f-298f-427b-81e0-aa682413b3a4">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="bdd556e5-144d-43c5-acf0-c02bd292d2e7" data-root-id="p1085" style="display: contents;"></div>
