...
```
    ...
    <div>
        ...
        <span id="ab4ad640-8b62-4f6c-921b-2ecd959d428d">Loading BokehJS ...</span>
    </div>

    Unable to display output for mime type(s): application/javascript, application/vnd.bokehjs_load.v0+json

  <div id="ea6befee-01c9-45cc-8923-02bde7e507d2" data-root-id="p1085" style="display: contents;"></div>
