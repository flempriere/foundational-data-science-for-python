...
```
    ...
    Symmetric Difference: {'admitted', 'major', 'minor', 'gpa', 'advisor'}
    Intersection: {'first', 'last', 'id'}
    Difference: {'admitted'}
    Union: {'first', 'admitted', 'last', 'major', 'minor', 'gpa', 'advisor', 'id'}
...
```
    ...
    Calling __hash__ on string: 8342675592861064130
