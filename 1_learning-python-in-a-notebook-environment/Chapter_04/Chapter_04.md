...
```
    ...
    Symmetric Difference: {'gpa', 'major', 'minor', 'admitted', 'advisor'}
    Intersection: {'last', 'first', 'id'}
    Difference: {'admitted'}
    Union: {'gpa', 'id', 'major', 'minor', 'admitted', 'advisor', 'last', 'first'}
...
```
    ...
    Calling __hash__ on string: 8201163409990272407
