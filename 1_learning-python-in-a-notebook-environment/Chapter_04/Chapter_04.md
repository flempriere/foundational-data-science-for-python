...
```
    ...
    Symmetric Difference: {'major', 'admitted', 'advisor', 'gpa', 'minor'}
    Intersection: {'first', 'last', 'id'}
    Difference: {'admitted'}
    Union: {'major', 'gpa', 'admitted', 'id', 'advisor', 'first', 'last', 'minor'}
...
```
    ...
    Calling __hash__ on string: 3580631770831383163
