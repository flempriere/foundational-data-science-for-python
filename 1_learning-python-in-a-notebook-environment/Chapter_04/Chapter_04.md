...
```
    ...
    Symmetric Difference: {'minor', 'major', 'gpa', 'advisor', 'admitted'}
    Intersection: {'last', 'id', 'first'}
    Difference: {'admitted'}
    Union: {'minor', 'major', 'gpa', 'last', 'advisor', 'admitted', 'id', 'first'}
...
```
    ...
    Calling __hash__ on string: -8219191855815053185
