...
```
    ...
    Symmetric Difference: {'minor', 'admitted', 'advisor', 'major', 'gpa'}
    Intersection: {'first', 'id', 'last'}
    Difference: {'admitted'}
    Union: {'minor', 'admitted', 'last', 'advisor', 'major', 'first', 'gpa', 'id'}
...
```
    ...
    Calling __hash__ on string: -1957576131458746642
