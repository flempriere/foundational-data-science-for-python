...
```
    ...
    Symmetric Difference: {'advisor', 'minor', 'major', 'gpa', 'admitted'}
    Intersection: {'first', 'id', 'last'}
    Difference: {'admitted'}
    Union: {'advisor', 'minor', 'major', 'id', 'gpa', 'last', 'first', 'admitted'}
...
```
    ...
    Calling __hash__ on string: 3598572738345293997
