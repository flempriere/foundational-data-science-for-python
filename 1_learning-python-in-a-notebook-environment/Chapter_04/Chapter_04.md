...
```
    ...
    Symmetric Difference: {'minor', 'major', 'gpa', 'admitted', 'advisor'}
    Intersection: {'first', 'last', 'id'}
    Difference: {'admitted'}
    Union: {'advisor', 'first', 'last', 'major', 'gpa', 'admitted', 'id', 'minor'}
...
```
    ...
    Calling __hash__ on string: 3905144195078741054
