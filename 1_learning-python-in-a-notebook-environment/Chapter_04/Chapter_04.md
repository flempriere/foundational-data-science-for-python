...
```
    ...
    Symmetric Difference: {'major', 'minor', 'admitted', 'gpa', 'advisor'}
    Intersection: {'id', 'first', 'last'}
    Difference: {'admitted'}
    Union: {'id', 'major', 'first', 'minor', 'admitted', 'gpa', 'advisor', 'last'}
...
```
    ...
    Calling __hash__ on string: -6596201590943501537
