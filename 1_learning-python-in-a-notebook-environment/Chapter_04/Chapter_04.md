...
```
    ...
    Symmetric Difference: {'advisor', 'gpa', 'admitted', 'minor', 'major'}
    Intersection: {'first', 'id', 'last'}
    Difference: {'admitted'}
    Union: {'id', 'first', 'advisor', 'last', 'gpa', 'admitted', 'minor', 'major'}
...
```
    ...
    Calling __hash__ on string: -8920960740150298169
