...
```
    ...
    Symmetric Difference: {'major', 'minor', 'admitted', 'advisor', 'gpa'}
    Intersection: {'id', 'last', 'first'}
    Difference: {'admitted'}
    Union: {'id', 'last', 'major', 'minor', 'first', 'admitted', 'advisor', 'gpa'}
...
```
    ...
    Calling __hash__ on string: -1267892382682818623
