...
```
    ...
    Symmetric Difference: {'advisor', 'minor', 'admitted', 'major', 'gpa'}
    Intersection: {'last', 'first', 'id'}
    Difference: {'admitted'}
    Union: {'last', 'first', 'minor', 'admitted', 'advisor', 'id', 'major', 'gpa'}
...
```
    ...
    Calling __hash__ on string: -6022414209087568491
