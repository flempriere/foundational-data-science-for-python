...
```
    ...
    Symmetric Difference: {'advisor', 'gpa', 'admitted', 'major', 'minor'}
    Intersection: {'id', 'first', 'last'}
    Difference: {'admitted'}
    Union: {'id', 'gpa', 'advisor', 'admitted', 'first', 'major', 'minor', 'last'}
...
```
    ...
    Calling __hash__ on string: -3974532939818286488
