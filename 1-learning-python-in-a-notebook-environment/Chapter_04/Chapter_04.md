...
```
    ...
    Symmetric Difference: {'minor', 'admitted', 'gpa', 'major', 'advisor'}
    Intersection: {'first', 'last', 'id'}
    Difference: {'admitted'}
    Union: {'admitted', 'minor', 'first', 'gpa', 'id', 'major', 'last', 'advisor'}
...
```
    ...
    Calling __hash__ on string: 9159815887330654721
